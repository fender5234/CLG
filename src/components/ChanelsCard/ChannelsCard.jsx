import './channels-card.scss';

function ChannelsCard({name = "Название канала",image='src/assets/svg/logo-big.svg',statusChanel }) {
  return (
    <div className='chanels-card-inner-wrapper'>
      <img src={image} alt="Фотография канала" />
      <h3>{name}</h3>
      {statusChanel ? <p>
      ...
      {
        statusChanel ? <button type='button'>
